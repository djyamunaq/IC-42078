...
int main (int argc, char** argv) {
    ...
    path outputPath = absolute("../ex_2_data.comp");
    compressor.compress(inputPath, outputPath);

    /******************************************************************************/
    /* 2. DECOMPRESS FILE BACK TO .Y4M FORMAT                                     */
    /******************************************************************************/
    cout << "> Decompress file..." << endl;

    inputPath = absolute("../ex_2_data.comp");
    outputPath = absolute("../ex_2_data_decompressed");
